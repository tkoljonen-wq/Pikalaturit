...
- **23.9.2026 — "Uudet pikalaturit" -lista Trendit-välilehdelle** (ei suunnitelmassa):
  kymmenen uusinta tapahtumaa ja haku valitulta aikaväliltä. Rivi = yhden aseman
  yhtenä päivänä saama erä latureita, ei rivi per laturi; tapahtuma on joko uusi
  asema tai laajennus (olemassa olevalle asemalle lisätyt laturit). AFIR-datassa
  ei ole aseman perustamis- tai avauspäivää eikä sitä saa takautuvasti mistään,
